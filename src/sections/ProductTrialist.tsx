        ...
        {activeTab === 'available' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {availableProducts.map((product, index) => (
              <ScrollReveal key={product.id} animation="fade-up" delay={300 + index * 100}>
                <div className="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{ width: `${(product.applied / (product.applied + product.slots)) * 100}%` }}
                        />
                      </div>
                    </div>

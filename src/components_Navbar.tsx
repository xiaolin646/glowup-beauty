        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-1 flex-shrink-0 pl-2">
            <button 
              ...
              className="p-2.5 rounded-full hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-colors cursor-pointer flex-shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
            ...
            <button 
              onClick={onCartClick}
              className="p-2.5 rounded-full hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-colors cursor-pointer relative flex-shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
            ...
            <button 
              onClick={onUserClick}
              className="p-2.5 rounded-full hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-colors cursor-pointer overflow-hidden flex-shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
            ...
            {/* Mobile menu button */}
            <button
              className="lg:hidden p-2.5 rounded-full hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-colors cursor-pointer flex-shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center"
